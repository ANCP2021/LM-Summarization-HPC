...
def bert_score(generated, reference):
    precision, recall, f1 = bert_score.score(generated_summaries, reference_summaries, lang="en")
...
if __name__ == '__main__':
    ...
    precision_bert, recall_bert, f1_bert = bert_score(generated_summaries, reference_summaries)
